...
void bounce_roll_lr(uint8_t *msg, uint32_t msgLen, uint8_t *output, uint32_t keySum, uint8_t *table,
                    uint8_t *key);
void bounce_roll_rl(uint8_t *msg, uint32_t msgLen, uint8_t *output, uint32_t keySum, uint8_t *table,
                    uint8_t *key);
